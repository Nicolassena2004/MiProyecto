...
public interface PasswordCheckerPort {package com.login.domain.port.output;
    ...
    public interface PasswordCheckerPort {
        ...
        /**
         * el bolean el decir si o no
         * el matches lo que hace es tomar el raw y compararlo con el encode para ver si coinciden y despues el bolena dice si;
         * si la contrasela es correcta o no
         */
    }
}
